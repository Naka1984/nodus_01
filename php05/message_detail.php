...
//4  既読フラグの設定
$pdo = db_conn();
$stmt2 = $pdo->prepare('UPDATE message SET status=1 WHERE id=:id;');
...
<body>
  <div class="slidemenu slidemenu-left">
    <div class="slidemenu-header">
        ...
        <div class='user_logintime'>最終ログイン:<?php echo $login_date; ?></div>
    </div>
    <div class="slidemenu-body">
      <ul class="slidemenu-content">
      <li style='background-color:#222222; height:30px; vertical-align:middle;' ><a  style='padding:0px 0px 0px 10px; color:white ' > スプレッドシート連携</a></li>
      <li><a class="menu-item" href="https://docs.google.com/spreadsheets/d/1G_TBZlJnlL_nCz1jNHsmEgABRg7OpRYusg7abPzh3HM/edit#gid=1124570819"  target="_blank" rel="noopener noreferrer">要件定義書トップ</a></li>
        ...
        <li style='background-color:#222222; height:30px; vertical-align:middle;' ><a  style='padding:0px 0px 0px 10px; color:white' > メッセージ</a></li>       
        ...
        <li style='background-color:#222222; height:30px; vertical-align:middle;' ><a  style='padding:0px 0px 0px 10px; color:white ' >学習関係</a></li>
        ...
        <li><a class="menu-item" href="<?= $git ?>"  target="_blank" rel="noopener noreferrer">GitHub</a></li>
        <li style='background-color:#222222; height:30px; vertical-align:middle;' ><a  style='padding:0px 0px 0px 10px; color:white' > 設定</a></li>    
        <?php if ($kanri_flg == 1) {echo('<li><a class="menu-item" href="user_data.php">ユーザー設定</a></li>');} ?>
  ...
  <div id="main"  style='background-color:aliceblue'>
    ...
    <div><p style='font-size:xx-large'>対応依頼</p><br/><br/><br/></div>
    ...
    <table>
        ...
        <tr>
            <td style="background-color:darkblue; color:white; height:200px; vertical-align:middle">本文</td><td colspan="2";  style= "background-color:white; height:200px"><?= $row['text'] ?></td>
        </tr>
    </table>

    <div class="content" style='padding: 10px 0px 0px 0px;'>
        <div class="inner">
            <button><a href='message_index.php' style='text-decoration: none; color:black'>一覧に戻る</a></button>
            <button>削除</button>
            <button>報告</button>
        </div>
    </div>
    ...
    <!-- <form method="POST" action="post_update.php">
        <div class="jumbotron">
            <fieldset>
                <img src='<?php echo $row['destination_user_photo']; ?>' style="padding-top: 0px; width:60px; height:60px ">
                <label style='font-size:large'>送信元：<?= $row['user_id'] ?></label><br>               
                <label style='font-size:large'>件名：<?= $row['title'] ?></label><br>
                <label style='font-size:large'>受信日時：<?= $row['created_at'] ?></label><br><br><br/>
                <label style='font-size:large'>本文：<?= $row['text'] ?></label><br>
    ...
    <form method="POST" action="post_update.php">
        <div class="jumbotron">
            <fieldset>
                ...
                <label>本文：<input type="text" name="text" value="<?= $row['text'] ?>"></label><br>
                <input type="submit" value="送信">
                <input type="hidden" name="id" value="<?= $id ?>">
            </fieldset>
        </div>
